...
class EventoModel {
  ...
  factory EventoModel.fromJson(String source) => EventoModel.fromMap(json.decode(source));
...
class Unidade {
  ...
  factory Unidade.fromJson(String source) => Unidade.fromMap(json.decode(source));
